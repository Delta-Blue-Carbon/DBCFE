...
function EditForm(props) {
  ...
  const clipToClipboard = () => {
    navigator.clipboard.writeText(window.location.origin + "/shared-form/" + formDeatils.id)
    handleClickOfAlert();
    handleClose();
  }
              ...
              <DialogContent>
                <Paper className={classes.paper}>
                  <Grid container alignContent="space-between" alignItems="center">
                    <Grid item>
                      <Typography variant="body1">{window.location.origin + "/shared-form/" + formDeatils.id}</Typography>
                ...
                {/* <div style={{padding: '7px', display: 'flex'}}>
                  <Typography variant="body1">{window.location.origin + "/shared-form/" + formDeatils._id}</Typography>
                    
                  <IconButton onClick={() =>  navigator.clipboard.writeText(window.location.origin + "/shared-form/" + formDeatils._id)}  >
                    <MoreIcon />
                  </IconButton>
                  </div> */}
