...
import authService from '../../apis/survey/authService';
...
const CLIENT_ID = '900668210622-8dhkfa9iq5a07k8guco00da445geond4.apps.googleusercontent.com';
...
function Login(props){
    ...
    const loginGoogle = ()=>{
        let response = {
          profileObj:{
            imageUrl: 'https://static.thenounproject.com/png/3244607-200.png',
            name: 'Ali Jone',
            email: 'alijonemerchant@gmail.com'
          }
        }
        // response.profileObj.image = '';
        // response.profileObj.name = 'Ali Jone';
        // response.profileObj.email = 'alijonemerchant@gmail.com';
